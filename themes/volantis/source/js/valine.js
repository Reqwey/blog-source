!function(e, t) {
    ...
    return e = [function(e, t, n) {
        ...
        Array.prototype.forEach || (Array.prototype.forEach = function(e, t) {
            ...
            var a, o = Object(this), i = o.length >>> 0;
        ...
        a.default)(l.default.fn, {
            ...
            removeClass: function(e) {
                return this.forEach(function(t) {
                    var o, n = (0,
                    l.default)(t), r = n.attr("class");
                    n.hasClass(e) && (o = new RegExp("(\\s|^)" + e + "(\\s|$)"),
        ...
        a.default)(l.default, {
            ...
            dynamicLoadSource: function(e, t) {
                var n;
                (0,
                l.default)('script[src="' + e + '"]').length ? t && t() : ((n = f.createElement("script")).onload = n.onreadystatechange = function() {
            ...
            ajax: function(e) {
                ...
                r.onreadystatechange = function(t) {
                    var o;
                    4 == r.readyState && (clearTimeout(n),
                    200 <= (o = r.status) && o < 300 ? e.success && e.success(JSON.parse(r.responseText)) : e.fail && e.fail(o))
                }
                ,
                "GET" == e.type ? (r.open("GET", e.url + "?" + t, e.async),
                r.send(null)) : "POST" == e.type && (r.open("POST", e.url, e.async),
                null == e.contentType || null == e.contentType ? r.send(t) : (r.setRequestHeader("Content-Type", e.contentType),
    ...
    , function(e, t, n) {
        ...
        var l = o ? function() {
          ...
          , m = n(4).call(Function.call, String.prototype.replace)
          , y = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g
          , b = /\\(\\)?/g;
        e.exports = function(e, t) {
            ...
            for (var n = function(e) {
                ...
                return v[e]
            }("%" + (0 < n.length ? n[0] : "") + "%", t), a = 1; a < n.length; a += 1)
                if (null != i)
                    if (o && a + 1 >= n.length) {
                        var s = o(i, n[a]);
                        if (!(t || n[a]in i))
    ...
    , function(e, t, n) {
        function r(e) {
            var n, t = d.spaceIndex(e);
            return n = -1 === t ? e.slice(1, -1) : e.slice(1, t + 1),
            "/" === (n = d.trim(n).toLowerCase()).slice(0, 1) && (n = n.slice(1)),
        ...
        t.parseTag = function(e, t, n) {
            for (var i = "", a = 0, s = !1, l = !1, c = 0, u = e.length, d = "", p = "", c = 0; c < u; c++) {
                var f = e.charAt(c);
                if (!1 === s) {
                    if ("<" === f) {
                        s = c;
        ...
        t.parseAttr = function(e, t) {
            function n(e, n) {
                var r;
                (e = (e = d.trim(e)).replace(p, "").toLowerCase()).length < 1 || (r = t(e, n || "")) && o.push(r)
            }
    ...
    , function(e, t, n) {
        ...
        o.prototype._init = function() {
            ...
            try {
                ...
                var u = T.ds
                  , d = r ? "&q=" + h.RandomStr : "";
                T.params = "?d=" + (-1 < u.indexOf(n) ? n : "mp") + "&v=" + h.VERSION + d,
                T.hide = "hide" === n,
                T.cdn = /^https?\:\/\//.test(o) ? o : T.cdn,
                e.config.pageSize = isNaN(l) || l < 1 ? 10 : l,
                c && (0,
                _.recordIPFn)(function(e) {
                    return E.ip = e
                });
                var v, g, m, b, w, p = e.config.el || null, f = (0,
                y.default)(p);
                (p = p instanceof HTMLElement ? p : f[f.length - 1] || null) && (e.$el = (0,
                y.default)(p),
                ...
                e.config.meta = (e.config.guest_info || e.config.meta || h.defaultMeta).filter(function(e) {
                    return -1 < h.defaultMeta.indexOf(e)
                }),
                e.config.requiredFields = e.config.requiredFields.filter(function(e) {
                    return -1 < h.defaultMeta.indexOf(e)
                }),
                v = (0 == e.config.meta.length ? h.defaultMeta : e.config.meta).map(function(t) {
                    var n = "mail" == t ? "email" : "text";
                    return -1 < h.defaultMeta.indexOf(t) ? '<input name="' + t + '" placeholder="' + (e.config.metaPlaceholder[t] || e.i18n.t(t)) + '" class="v' + t + ' vinput" type="' + n + '">' : ""
                }),
                ...
                k.default)(e.config, function(t) {
                    ...
                    !function t(n) {
                        var i, o = n[r++];
                        !o || (i = (0,
                        y.default)(o).attr("data-xid")) && e.Q(i).count().then(function(e) {
                            o.innerText = e,
                            t(n)
                        }).catch(function(e) {
                            o.innerText = 0
        ...
        var I = {
            add: function(e, t) {
                ...
                decodeURI(i) === decodeURI(t) ? ((c = new AV.Query(e)).equalTo("url", i),
                c.find().then(function(t) {
                    var n;
                    0 < t.length ? ((n = t[0]).increment("time"),
                    n.save().then(function(e) {
                        (0,
                        y.default)(o).find(".leancloud-visitors-count").text(e.get("time"))
                    }).catch(function(e) {})) : C(e, l)
                }).catch(function(t) {
                    101 == t.code ? C(e, l) : (0,
                    $.default)(n, t)
                })) : I.show(e, r)) : I.show(e, r)
            },
            show: function(e, t) {
                var r, n = [];
                t.forEach(function(e) {
                ...
                n.length && ((r = new AV.Query(e)).containedIn("url", n),
                r.find().then(function(e) {
                    0 < e.length && t.forEach(function(t) {
                        e.forEach(function(e) {
                            var a, n = e.get("xid") || encodeURI(e.get("url")), r = e.get("time"), o = (0,
                            y.default)(t), i = o.attr("id");
                            (/\%/.test(i) ? i : encodeURI(i)) != n || (a = o.find(".leancloud-visitors-count")) && a.text(r)
                        })
                    })
                }).catch(function(e) {}))
            }
        ...
        o.prototype.Q = function(e) {
            ...
            var l = "select * from " + r + " where rid in (" + JSON.stringify(arguments[1]).replace(/(\[|\])/g, "") + ") order by -createdAt,-createdAt";
        ...
        o.prototype.bind = function() {
            ...
            function d(t) {
                ...
                r || e.$preview.hide(),
                j != r && (j = r,
                -1 < o.hasClass("actived") && j != n.html() && n.html(j),
                (0,
                c.default)(t[0]),
                M())
            }
            ...
            for (var b in p.forEach(function(e) {
                m["v" + e] = e
            }),
            m)
                m.hasOwnProperty(b) && function() {
                    var t = m[b]
                      , n = e.$el.find("." + b);
                    (v[t] = n).on("input change blur propertychange", function(r) {
            ...
            var O = function() {
                ...
                o.find().then(function(o) {
                    ...
                    t * n < r ? A.show() : A.hide()) : e.$nodata.show(),
                    e.$loading.hide()
                }).catch(function(t) {
                    e.$loading.hide(),
                    (0,
            ...
            e.Q(e.config.path).count().then(function(t) {
                0 < t ? (e.$el.find(".vcount").show().find(".vnum").text(t),
                O()) : e.$loading.hide()
            }).catch(function(t) {
                (0,
                $.default)(e, t, "count")
            ...
            var C = function(t, n, r) {
                ...
                s.default)(t.get("mail").toLowerCase()))
                  ...
                  , qqm = t.get("mail").match(/([\d]+)@(vip\.)?qq.com/)
                  , qqa = qqm ? "https://q2.qlogo.cn/headimg_dl?dst_uin=" + qqm + "&spec=100" : null
                  , qal = e.config.enableQQ && t.get("QQAvatar") ? t.get("QQAvatar") : qqa
                  , l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : ""
                  , c = l ? '<a class="vnick" rel="nofollow" href="' + l + '" target="_blank" >' + t.get("nick") + "</a>" + gat : '<span class="vnick">' + t.get("nick") + "</span>" + gat
                  , d = (T.hide ? "" : qal ? '<img class="vimg" src="' + qal + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (T.cdn + (0,
                s.default)(t.get("mail")) + T.params) + '">') + '<div class="vh"><div class="vhead">' + c + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0,
              ...
              , R = function(e) {
                setTimeout(function() {
                    200 < e[0].offsetHeight && (e.addClass("expand"),
            ...
            ;
            function L(t) {
                return -1 < e.config.requiredFields.indexOf("nick") && E.nick.length < 3 ? (v.nick[0].focus(),
                void e.$el.find(".status-bar").text("" + e.i18n.t("nickFail")).empty(3e3)) : -1 < e.config.requiredFields.indexOf("mail") && !/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/.test(E.mail) ? (v.mail[0].focus(),
                void e.$el.find(".status-bar").text("" + e.i18n.t("mailFail")).empty(3e3)) : void ("" != j ? (E.comment = j,
                E.nick = E.nick || "Anonymous",
                (n = y.default.store.get("vlx")) && Date.now() / 1e3 - n / 1e3 < 20 ? e.$el.find(".status-bar").text(e.i18n.t("busy")).empty(3e3) : U()) : v.comment[0].focus());
                var n
            }
            var z = e.$el.find(".vsubmit")
              , U = function() {
                ...
                e.$loading.show(!0);
                var r, i, n = new (AV.Object.extend(e.config.clazzName || "Comment"));
                for (var o in E.url = decodeURI(e.config.path),
    ...
    , function(e, t, n) {
        ...
        t.default = function(e, t) {
            ...
            2 < parseInt(n.split(".")[0]) ? i = !!AV.applicationId && !!AV.applicationKey : o.default.deleteInWin("AV", 0)),
            i ? t && t() : o.default.sdkLoader("//cdn.jsdelivr.net/npm/leancloud-storage@3/dist/av-min.js", "AV", function(n) {
                var o, r = "https://", a = e.app_id || e.appId, s = e.app_key || e.appKey;
                if (!e.serverURLs)
                    switch (a.slice(-9)) {
                    case "-9Nh9j0Va":
                        r += "tab.";
    ...
    , function(e, t, n) {
        ...
        t.default = function(e, t) {
            ...
            isNaN(n) ? e.$el && e.$nodata.show('<pre style="text-align:left;"> ' + JSON.stringify(t) + "</pre>") : (o = ((r = e.i18n.t("code-" + n)) == "code-" + n ? void 0 : r) || t.message || t.error || "",
            101 == n || -1 == n ? e.$nodata.show() : e.$el && e.$nodata.show('<pre style="text-align:left;">Code ' + n + ": " + o + "</pre>"))) : e.$el && e.$nodata.show('<pre style="text-align:left;">' + JSON.stringify(t) + "</pre>")
        }
    }
    , function(e, t, n) {
        "use strict";
    ...
    , function(e, t, n) {
        ...
        var i = function(e, t, n, r) {
            ...
            if ("img" === e && -1 < ["src", "class"].indexOf(t))
    ...
    , function(e, t, n) {
        ...
        !function() {
            ...
            function p(e, t) {
                e[t >> 5] |= 128 << t % 32,
                e[14 + (t + 64 >>> 9 << 4)] = t;
                for (var r, o, a, s, p = 1732584193, f = -271733879, h = -1732584194, v = 271733878, n = 0; n < e.length; n += 16)
                    p = l(r = p, o = f, a = h, s = v, e[n], 7, -680876936),
                    ...
                    p = c(p, f = l(f, h, v, p, e[n + 15], 22, 1236535329), h, v, e[n + 1], 5, -165796510),
                    ...
                    p = u(p, f = c(f, h, v, p, e[n + 12], 20, -1926607734), h, v, e[n + 5], 4, -378558),
                    ...
                    p = d(p, f = u(f, h, v, p, e[n + 2], 23, -995338651), h, v, e[n], 6, -198630844),
            ...
            function h(e) {
                ...
                t = 0; t < n.length; t += 1)
                    n[t] = 0;
                for (var r = 8 * e.length, t = 0; t < r; t += 8)
                    n[t >> 5] |= (255 & e.charCodeAt(t / 8)) << t % 32;
                return n
            }
            function m(e) {
                for (var t, r = "0123456789abcdef", o = "", n = 0; n < e.length; n += 1)
                    t = e.charCodeAt(n),
    ...
    , function(e, t, n) {
        ...
        t.default = function(e) {
            ...
            n.Mobile && (n.Mobile = !(-1 < e.indexOf("iPad")));
            var r = {
        ...
        i.prototype.process = function(e) {
            ...
            return s(e, function(e, t, n, s, c) {
                ...
                s = l(n, s)) {
                    ...
                    return d ? r(f = i(n, s, p)) ? n + ":" + s : f : r(f = a(n, s, p)) ? void 0 : f
                }
            })
        }
        ,
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t) {
            function n() {
                var n, r, c, u, d;
                i || -1 !== (r = (n = o.trim(e.slice(a, s))).indexOf(":")) && (c = o.trim(n.slice(0, r)),
                u = o.trim(n.slice(r + 1)),
                !c || (d = t(a, l.length, c, u, n)) && (l += d + "; ")),
                a = s + 1
            }
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t, n) {
            ...
            ("[object Array]" === o.call(e) ? a : "string" == typeof e ? function(e, t, n) {
                for (var r = 0, o = e.length; r < o; r++)
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            for (var i = r.call(arguments, 1), s = Math.max(0, t.length - i.length), l = [], c = 0; c < s; c++)
                l.push("$" + c);
            var u, n = Function("binder", "return function (" + l.join(",") + "){ return binder.apply(this,arguments); }")(function() {
            ...
            !function() {
                ...
                function h(e, t, r) {
                    ...
                    if (r || "function" == typeof t) {
                        r || (r = t,
                        t = null);
                        var o, i, l = (t = p({}, h.defaults, t || {})).highlight, c = 0;
                        try {
                            o = n.lex(e, t)
                        } catch (e) {
                            return r(e)
                    ...
                    for (var n, r, o, i, a, s, l, c, u, d, p, h, g; e; )
                        ...
                        o = this.rules.code.exec(e))
                            ...
                            c = 0; c < d; c++)
                                ...
                                this.options.smartLists && c !== d - 1 && (i === (a = v.bullet.exec(o[c + 1])[0]) || 1 < i.length && 1 < a.length || (e = o.slice(c + 1).join("\n") + e,
                                c = d - 1)),
                                r = n || /\n\n(?!\s*$)/.test(s),
                                c !== d - 1 && (n = "\n" === s.charAt(s.length - 1),
                                r = r || n),
                ...
                r.prototype.output = function(e) {
                    for (var t, n, o, i, a, l = ""; e; )
                        if (a = this.rules.escape.exec(e))
                            ...
                            e = e.substring(a[0].length),
                            o = "@" === a[2] ? "mailto:" + (n = s(this.mangle(a[1]))) : n = s(a[1]),
                            ...
                            if (a = this.rules.tag.exec(e))
                                ...
                                this.inLink = !0,
                                o = a[2],
                                i = this.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(o)) ? (o = t[1],
                ...
                o.prototype.code = function(e, t, n) {
                    var r;
                    return !this.options.highlight || null != (r = this.options.highlight(e, t)) && r !== e && (n = !0,
                    e = r),
                ...
                a.prototype.tok = function() {
                    ...
                    case "table":
                        for (var t, r, o = "", i = "", n = "", e = 0; e < this.token.header.length; e++)
    ...
    , function(e, t, n) {
        ...
        function l(e, t, n, r, o) {
            ...
            if (null == t)
                return e;
            var u, a = e, s = r || w, l = o || b, c = "number" == typeof t ? {
                smart_count: t
            } : t;
            return null != c.smart_count && a && (u = g.call(a, m),
            a = f(u[i(l, n || "en", c.smart_count)] || u[0])),
            v.call(a, s, function(e, t) {
        ...
        c.prototype.t = function(e, t) {
            var n, r, o = null == t ? {} : t;
            return "string" == typeof this.phrases[e] ? n = this.phrases[e] : "string" == typeof o._ ? n = o._ : r = this.onMissingKey ? (0,
            this.onMissingKey)(e, o, this.currentLocale, this.tokenRegex, this.pluralRules) : (this.warn('Missing translation for key: "' + e + '"'),
            e),
            "string" == typeof n && (r = l(n, o, this.currentLocale, this.tokenRegex, this.pluralRules)),
            r
        }
        ,
    ...
    , function(e, t, n) {
        "use strict";
        var o, i, a, s, l, c, u, d, p, f, h, r;
        Object.keys || (o = Object.prototype.hasOwnProperty,
        i = Object.prototype.toString,
        a = n(10),
    ...
    , function(e, t, n) {
        ...
        var u = function(e) {
            var n, t = "_Is_Incognit";
            try {
                e.setItem(t, "yes")
            } catch (t) {
                "QuotaExceededError" === t.name && (n = function() {}
                ,
                e.__proto__ = {
                    setItem: n,
                    getItem: n,
    ...
    , function(e, t, n) {
        ...
        (function(t) {
            var r = function() {};
            "production" !== t.env.NODE_ENV && (r = function(e, t, n) {
    ...
    , function(e, t, n) {
        ...
        var o = n(15)
          , i = n(16)
          , a = n(52);
        for (var s in (t = e.exports = r).filterXSS = r,
        t.FilterXSS = a,
        o)
            t[s] = o[s];
        for (var s in i)
    ...
    , function(e, t, n) {
        ...
        a.prototype.process = function(e) {
            ...
            var m = !1;
            n.stripIgnoreTagBody && (s = (m = l.StripTagBody(n.stripIgnoreTagBody, s)).onIgnoreTag);
            var y = u(e, function(e, t, n, l, u) {
                ...
                if (m.isWhite) {
                    ...
                    var b = function(e) {
                        ...
                        var n = "/" === (e = p.trim(e.slice(t + 1, -1)))[e.length - 1];
                      ...
                      , x = d(b.html, function(e, t) {
                        var o = -1 !== p.indexOf(w, e)
                          , i = c(n, e, t, o);
                        return r(i) ? o ? (t = h(n, e, t, g)) ? e + '="' + t + '"' : e : r(i = f(n, e, t, o)) ? void 0 : i : i
                    })
                      , l = "<" + n;
                    return x && (l += " " + x),
                    b.closing && (l += " /"),
    ...
    , function(e, t, n) {
        ...
        function u(e, t) {
            ...
            return o = t.singleton ? (c = y++,
            n = m = m || s(t),
            r = d.bind(null, n, c, !1),
            d.bind(null, n, c, !0)) : e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = l(t),
            r = function(e, t, n) {
                var r = n.css
                  , o = n.sourceMap
        ...
        function d(e, t, n, r) {
            var i, a, o = n ? "" : r.css;
            e.styleSheet ? e.styleSheet.cssText = x(t, o) : (i = document.createTextNode(o),
            (a = e.childNodes)[t] && e.removeChild(a[t]),
        ...
        var h = {}
          ...
          , g = function() {
            var t = {};
            return function(n) {
                return void 0 === t[n] && (t[n] = function(e) {
